...
export default function RegisterScreen() {
  ...
  // Lock performer selection if coming from performer registration
  useEffect(() => {
    if (params.type === 'performer') {
      setIsPerformer(true);
    }
  }, [params.type]);
          ...
          {(isPerformer || params.type === 'performer') && (
            <View style={styles.inputContainer}>
              <TextInput
                ...
                placeholder="Bio (e.g., Guitarist, Singer, Genre)"
                placeholderTextColor="#666"
                value={bio}
                onChangeText={setBio}
                multiline
